...
function chooseWolfAction(state, actions, random, strategy) {
...
function runCandidateGame(level, strategy, seed, hardMaxNodes) {
    ...
    const random = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$rng$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSeededRng"])(seed);
    const trace = [];
    ...
    while(state.status === 'playing'){
        ...
        const action = state.toMove === 'wolf' ? chooseWolfAction(state, actions, random, strategy) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["pickSheepAction"])(state, {
            difficulty: level.ai,
            rng: random,
...
function AiSimConsole(param) {
    let { initialLevel, initialDiff } = param;
...
_s(AiSimConsole, "FH7rpoSXxlYGrcx9i4zQutoRa4M=");
_c = AiSimConsole;
...
//# sourceMappingURL=_93107fe7._.js.map