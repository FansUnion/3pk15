...
_s(AiSimConsole, "7HnJIHGVhc6Ql6g2hcLAtXcnKWc=");
_c = AiSimConsole;
function gameRate(n, total) {
    return total > 0 ? n / total : 0;
}
function simulateOneGame(level, difficulty, seed) {
    let maxSteps = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 400, budgets = arguments.length > 4 ? arguments[4] : void 0;
