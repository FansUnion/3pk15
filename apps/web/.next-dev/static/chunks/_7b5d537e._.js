...
function AdminLevelWorkbench() {
    ...
    const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$18_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminLevelWorkbench.useMemo[filtered]": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$levels$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LEVELS"].filter({
                "AdminLevelWorkbench.useMemo[filtered]": (level)=>{
                    var _reports_level_id;
                    return (chapter === 'all' || level.chapterId === chapter) && (ai === 'all' || level.ai === ai) && (difficulty === 'all' || String(level.difficulty) === difficulty) && (!riskOnly || level.riskTags.length > 0) && (verdict === 'all' || (verdict === 'missing' ? !reports[level.id] : ((_reports_level_id = reports[level.id]) === null || _reports_level_id === void 0 ? void 0 : _reports_level_id.verdict) === verdict));
                }
    ...
    const verdictCounts = Object.values(reports).reduce((counts, report)=>({
            ...counts,
            [report.verdict]: counts[report.verdict] + 1
        }), {
        pass: 0,
        review: 0,
        reject: 0
...
function LevelCard(param) {
    let { level, review, report, selected, onSelect } = param;
    _s1();
...
//# sourceMappingURL=_7b5d537e._.js.map