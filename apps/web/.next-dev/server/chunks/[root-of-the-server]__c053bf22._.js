module.exports = [
"[project]/apps/web/.next-internal/server/app/api/admin/candidate/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/packages/game-core/src/types.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/game-core/src/board.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/types.ts [app-route] (ecmascript)");
;
function posKey(r, c) {
    return `${r},${c}`;
}
...
function inBounds(r, c) {
    return r >= __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BOARD_MIN"] && r <= __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BOARD_MAX"] && c >= __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BOARD_MIN"] && c <= __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BOARD_MAX"];
}
...
"[project]/packages/game-core/src/rules.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/board.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/types.ts [app-route] (ecmascript)");
;
;
...
function createInitialState(levelId, rocks = [], targetEaten = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["WIN_EATEN"], maxPlies = DEFAULT_MAX_PLIES, opening) {
    const rockSet = new Set(rocks.map((p)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["keyOf"])(p)));
    ...
    if (sheep.length !== __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["OPENING_SHEEP"]) throw new Error(`Opening must contain exactly ${__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["OPENING_SHEEP"]} sheep`);
    const occupied = new Set();
    for (const p of [
        ...wolves,
        ...sheep
    ]){
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["inBounds"])(p.r, p.c)) throw new Error(`Opening piece out of bounds at (${p.r},${p.c})`);
        const key = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["keyOf"])(p);
...
function occupancy(state) {
    ...
    for (const p of state.pieces){
        map.set((0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["posKey"])(p.r, p.c), p);
    }
    return map;
}
function isBlocked(state, r, c, occ) {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["inBounds"])(r, c)) return true;
    const k = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["posKey"])(r, c);
    if (state.rocks.has(k)) return true;
    return occ.has(k);
}
function listWolfSteps(state, wolf, occ) {
    const moves = [];
    for (const d of __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ORTHO"]){
        const nr = wolf.r + d.r;
        const nc = wolf.c + d.c;
...
/** 隔空吃：狼 — 空 — 羊；落到羊位并移除羊 */ function listWolfJumps(state, wolf, occ) {
    ...
    for (const d of __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ORTHO"]){
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["inBounds"])(tr, tc) || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["inBounds"])(lr, lc)) continue;
        const midKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["posKey"])(tr, tc);
        if (state.rocks.has(midKey) || occ.has(midKey)) continue;
        const target = occ.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["posKey"])(lr, lc));
...
function cloneState(state) {
    return {
        ...
        rocks: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cloneRocks"])(state.rocks),
        chain: state.chain ? {
            ...state.chain
        } : null,
...
function applyAction(state, action) {
    ...
    if (newCount >= __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MAX_CHAIN"]) {
        next.chain = null;
        next.toMove = 'sheep';
        return {
            ok: true,
...
function assertInvariants(state) {
    ...
    let wolves = 0;
    for (const p of state.pieces){
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["inBounds"])(p.r, p.c)) throw new Error(`Out of bounds ${p.id}`);
        const k = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["posKey"])(p.r, p.c);
    ...
    if (state.eatenSheep !== __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["OPENING_SHEEP"] - sheep) {
        throw new Error(`eatenSheep mismatch: ${state.eatenSheep} vs ${__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["OPENING_SHEEP"] - sheep}`);
    }
    if (state.chain) {
        if (state.toMove !== 'wolf') throw new Error('chain while not wolf turn');
        if (state.chain.count < 1 || state.chain.count > __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MAX_CHAIN"]) {
...
"[project]/packages/game-core/src/content/levels.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/types.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/board.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/rules.ts [app-route] (ecmascript)");
;
;
;
...
function openingPositions(level) {
    return {
        wolves: level.opening?.wolves ?? __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_WOLF_OPENING"],
        sheep: level.opening?.sheep ?? __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_SHEEP_OPENING"]
    };
}
function createLevelInitialState(level) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createInitialState"])(level.id, level.rocks, level.targetEaten, level.maxPlies, level.opening);
}
const CHAPTER_AI = {
    spring: 'normal',
    summer: 'normal',
...
function validateLevel(level) {
    ...
    for (const p of [
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["inBounds"])(p.r, p.c)) {
    ...
    for (const p of level.rocks){
        ...
        const k = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["keyOf"])(p);
    ...
    for (const a of level.rocks){
        for (const d of __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ORTHO"]){
            const nr = a.r + d.r;
            const nc = a.c + d.c;
            if (nr < __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BOARD_MIN"] || nr > __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BOARD_MAX"] || nc < __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BOARD_MIN"] || nc > __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BOARD_MAX"]) continue;
            if (seen.has((0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["posKey"])(nr, nc))) {
                const pair = [
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["keyOf"])(a),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["posKey"])(nr, nc)
                ].sort().join('|');
    ...
    if (errors.length === 0) {
        try {
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listLegalActions"])(createLevelInitialState(level)).length === 0) {
...
"[project]/packages/game-core/src/content/quests.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/game-core/src/content/save.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$levels$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/content/levels.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$quests$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/content/quests.ts [app-route] (ecmascript)");
;
;
...
function defaultSave() {
    return {
        ...
        quests: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$quests$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["emptyQuestState"])()
    };
}
...
function parseQuests(raw) {
    if (!raw || typeof raw !== 'object') return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$quests$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["emptyQuestState"])();
    const o = raw;
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$quests$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["refreshQuestPeriod"])({
        daily: {
...
function migrate(raw) {
    ...
    const unlockedChapters = Array.isArray(o.unlockedChapters) ? o.unlockedChapters.filter((x)=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$levels$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CHAPTER_ORDER"].includes(x)) : [];
    return {
        schemaVersion: 1,
...
function recomputeUnlockedChapters(save) {
    ...
    for(let i = 0; i < __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$levels$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CHAPTER_ORDER"].length - 1; i++){
        const chapter = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$levels$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CHAPTER_ORDER"][i];
        const next = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$levels$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CHAPTER_ORDER"][i + 1];
        const levels = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$levels$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["levelsForChapter"])(chapter);
...
function applyClearToSave(save, level, grant) {
    ...
    let quests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$quests$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["recordQuestMetric"])(save.quests, 'both', 'clears', 1);
    if (grant.universal > 0) {
        quests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$quests$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["recordQuestMetric"])(quests, 'both', 'fragments_earned', grant.universal);
    }
    const next = {
        ...save,
        clearedLevels,
...
function recordPlayStarted(save, levelId) {
    return {
        ...
        quests: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$quests$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["recordQuestMetric"])(save.quests, 'both', 'plays', 1)
    };
}
...
function grantUniversalFragments(save, amount) {
    ...
    if (amount > 0) {
        quests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$quests$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["recordQuestMetric"])(quests, 'both', 'fragments_earned', amount);
    }
    return {
        ...save,
        quests,
...
"[project]/packages/game-core/src/content/skins.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/game-core/src/serialize.ts [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
function deserialize(data) {
    ...
    return {
        ...
        repetitionCounts: new Map([
            [
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["boardPositionKey"])(state),
                1
            ]
        ])
    };
...
function makeState(partial) {
    const state = {
        ...
        rocks: new Set((partial.rocks ?? []).map(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["keyOf"])),
...
"[project]/packages/game-core/src/ai/evaluate.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
/** Empty ortho neighbors of wolves occupied by sheep or rocks count as pressing. */ function surroundScore(state) {
    const occ = new Set(state.pieces.map((p)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["posKey"])(p.r, p.c)));
    let score = 0;
    for (const w of wolfPositions(state)){
        ...
        for (const [dr, dc] of dirs){
            const k = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["posKey"])(w.r + dr, w.c + dc);
...
/** Keep sheep from choosing moves that leave the flock with no useful exits. */ function sheepMobilityScore(state) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listLegalActions"])({
        ...state,
        toMove: 'sheep',
        chain: null
    }).length;
...
function evaluate(state) {
    ...
    const summary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getWolfLegalSummary"])(state);
...
"[project]/packages/game-core/src/ai/rng.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/game-core/src/ai/easy.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/rules.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$evaluate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/ai/evaluate.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$rng$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/ai/rng.ts [app-route] (ecmascript)");
;
;
;
function pickEasy(state, rng) {
    const actions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listLegalActions"])(state);
    if (actions.length === 0) throw new Error('easy: no legal sheep moves');
    const scored = actions.map((action)=>{
        const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["applyAction"])(state, action);
        if (!result.ok) return {
            action,
            score: -Infinity
        };
        return {
            action,
            score: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$evaluate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["evaluateScore"])(result.state)
        };
    });
    ...
    return scored[(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$rng$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pickIndex"])(rng, scored.length)].action;
}
}),
"[project]/packages/game-core/src/ai/normal.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function pickNormal(state, rng) {
    ...
    for (const action of actions){
        ...
        const score = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$evaluate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["evaluateScore"])(result.state);
        if (score > best) {
            best = score;
            tops.length = 0;
            tops.push(action);
    ...
    return tops[(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$rng$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pickIndex"])(rng, tops.length)];
}
}),
"[project]/packages/game-core/src/ai/hard.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$evaluate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/ai/evaluate.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$rng$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/ai/rng.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$normal$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/ai/normal.ts [app-route] (ecmascript)");
;
;
;
;
 ...
 */ function worstWolfTurn(state, nodes, budget, start) {
    ...
    if (wolfState.chain) {
        const ended = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["endWolfTurn"])(wolfState);
        let worst = ended.ok ? ended.state : wolfState;
        let worstScore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$evaluate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["evaluateScore"])(worst);
        for (const action of (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listLegalActions"])(wolfState)){
            if (exhausted(nodes, budget, start)) break;
            nodes.n++;
            const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["applyAction"])(wolfState, action);
            if (!result.ok) continue;
            const candidate = worstWolfTurn(result.state, nodes, budget, start);
            const score = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$evaluate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["evaluateScore"])(candidate);
            if (score < worstScore) {
                worst = candidate;
                worstScore = score;
            }
    ...
    const actions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listLegalActions"])(wolfState);
...
/** Evaluate one additional sheep decision after the worst complete wolf turn. */ function bestNextSheepResponse(state, nodes, budget, start) {
    if (state.status !== 'playing' || state.toMove !== 'sheep' || exhausted(nodes, budget, start)) {
        return {
            score: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$evaluate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["evaluateScore"])(state),
            completed: false
        };
    }
    let best = -Infinity;
    let completed = false;
    for (const action of (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listLegalActions"])(state)){
        if (exhausted(nodes, budget, start)) break;
        nodes.n++;
        const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["applyAction"])(state, action);
        if (!result.ok) continue;
        const afterWolf = worstWolfTurn(result.state, nodes, budget, start);
        best = Math.max(best, (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$evaluate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["evaluateScore"])(afterWolf));
        completed = true;
    }
    return {
        score: best === -Infinity ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$evaluate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["evaluateScore"])(state) : best,
        completed
    };
}
function pickHardWithMeta(state, rng, budgets = DEFAULT_BUDGETS) {
        ...
        return result.ok ? [
            {
                action,
                result,
                immediateSheepScore: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$evaluate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["evaluateScore"])(result.state)
            }
        ] : [];
    });
    ...
    for (const { action, result, immediateSheepScore } of applicable){
        ...
        const immediate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$evaluate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["evaluateScore"])(afterWolf);
    ...
    if (tops.length === 0) {
        return {
            action: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$normal$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pickNormal"])(state, rng),
            meta: {
                degraded: true,
                nodes: nodes.n,
                elapsedMs,
    ...
    return {
        action: tops[(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$rng$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pickIndex"])(rng, tops.length)],
        meta: {
            degraded: false,
            nodes: nodes.n,
            elapsedMs,
...
"[project]/packages/game-core/src/ai/index.ts [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$easy$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/ai/easy.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$normal$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/ai/normal.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$hard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/ai/hard.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$rng$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/ai/rng.ts [app-route] (ecmascript)");
;
;
;
...
function pickSheepAction(state, ctx) {
    ...
    switch(ctx.difficulty){
        case 'easy':
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$easy$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pickEasy"])(state, ctx.rng);
        case 'normal':
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$normal$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pickNormal"])(state, ctx.rng);
        case 'hard':
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$hard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pickHard"])(state, ctx.rng, ctx.budgets);
        default:
            {
...
"[project]/packages/game-core/src/analysis/diagnosticWolf.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function entersRepeatedPosition(state) {
    return (state.repetitionCounts.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["boardPositionKey"])(state)) ?? 0) >= 2;
}
function chooseDiagnosticWolfAction(state, actions, random, strategy) {
    ...
    const evaluated = actions.map((action)=>{
        ...
        return {
            action,
            score: result.ok ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$evaluate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["evaluateScore"])(result.state) : Infinity,
...
"[project]/packages/game-core/src/analysis/candidateAcceptance.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/game-core/src/ai/index.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$rng$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/ai/rng.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$analysis$2f$diagnosticWolf$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/analysis/diagnosticWolf.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$levels$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/content/levels.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/rules.ts [app-route] (ecmascript)");
;
;
...
function terminalReason(state) {
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listWolfActionsAsIfTurn"])(state).length === 0) return 'wolvesTrapped';
    if (state.plyCount >= state.maxPlies) return 'maxPlies';
    if ((state.repetitionCounts.get((0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["boardPositionKey"])(state)) ?? 0) >= 3) return 'repetition';
    return 'unexpected';
}
function runCandidateGame(level, strategy, seed, hardMaxNodes) {
    let state = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$levels$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLevelInitialState"])(level);
    const wolfRandom = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$rng$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSeededRng"])(seed);
    const sheepRandom = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$rng$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSeededRng"])(seed ^ 0x5f3759df);
    const trace = [];
    const seenPositions = new Map();
    let firstCapturePly = null;
    let repetitionCycle;
    const observePosition = ()=>{
        const key = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["boardPositionKey"])(state);
    ...
    while(state.status === 'playing'){
        ...
        const action = state.toMove === 'wolf' ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$analysis$2f$diagnosticWolf$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["chooseDiagnosticWolfAction"])(state, actions, wolfRandom, strategy) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["pickSheepAction"])(state, {
            difficulty: level.ai,
            rng: sheepRandom,
        ...
        if (state.status === 'playing' && state.chain) {
            const ended = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["endWolfTurn"])(state);
...
function assessLevelCandidate(level, options = {}) {
    const structuralErrors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$levels$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateLevel"])(level);
...
"[project]/packages/game-core/src/index.ts [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$levels$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/content/levels.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$save$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/content/save.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$quests$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/content/quests.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$skins$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/content/skins.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/types.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/board.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/rules.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$serialize$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/game-core/src/serialize.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/game-core/src/ai/index.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$evaluate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/ai/evaluate.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$analysis$2f$candidateAcceptance$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/analysis/candidateAcceptance.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$analysis$2f$diagnosticWolf$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/analysis/diagnosticWolf.ts [app-route] (ecmascript)");
;
;
;
...
"[project]/apps/web/src/app/api/admin/candidate/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$18_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/next@15.5.18_react-dom@19.2.7_react@19.2.7__react@19.2.7/node_modules/next/server.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/game-core/src/index.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$analysis$2f$candidateAcceptance$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/analysis/candidateAcceptance.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$levels$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/src/content/levels.ts [app-route] (ecmascript)");
;
;
...
async function POST(request) {
    ...
    try {
        ...
        if (typeof body.baseLevelId !== 'string' || !body.candidate || typeof body.candidate !== 'object' || Array.isArray(body.candidate)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$18_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
                error: 'baseLevelId and candidate object are required'
            }, {
                status: 400
            });
        }
        const base = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$content$2f$levels$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getLevel"])(body.baseLevelId);
        if (!base) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$18_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: false,
            error: 'base level not found'
        }, {
            status: 404
        });
        const candidate = {
        ...
        const report = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$analysis$2f$candidateAcceptance$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assessLevelCandidate"])(candidate);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$18_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true,
            candidate,
            report
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$18_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: false,
            error: error instanceof Error ? error.message : 'candidate assessment failed'
        }, {
            status: 400
        });
    }
...
function checkAdminAccess(request) {
    if (process.env.ADMIN_ENABLED !== 'true' || (("TURBOPACK compile-time value", "standalone") ?? 'standalone') === 'portal') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$18_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c053bf22._.js.map