...
/** Opening piece positions — rocks must not occupy these. */ const OPENING_KEYS = new Set([
    ...[
        ...
        3
            ...
            4,
            5
        ].map((c)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["posKey"])(r, c))),
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["posKey"])(6, 2),
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["posKey"])(6, 3),
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["posKey"])(6, 5)
]);
const CHAPTER_AI = {
    spring: 'normal',
    summer: 'normal',
...
function createInitialState(levelId, rocks = [], targetEaten = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$types$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["WIN_EATEN"], maxPlies = DEFAULT_MAX_PLIES) {
    ...
    for (const p of [
        ...
        if (rockSet.has((0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$board$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["keyOf"])(p))) {
 ...
 */ function wolfGreedyMin(state, nodes, budget, start) {
    if (state.status !== 'playing') return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$evaluate$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["evaluateScore"])(state);
    const wolfState = {
        ...state,
        toMove: 'wolf',
        chain: null
    ...
    if (actions.length === 0) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$evaluate$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["evaluateScore"])(wolfState);
    let worst = Infinity;
    for (const action of actions){
        ...
        if (after.chain && after.status === 'playing') {
            const cont = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["listLegalActions"])(after);
        ...
        const score = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$evaluate$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["evaluateScore"])(after);
        if (score < worst) worst = score;
    }
    return worst === Infinity ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$ai$2f$evaluate$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["evaluateScore"])(state) : worst;
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9a9d7738._.js.map