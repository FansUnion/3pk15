...
function positionKey(state) {
    const pieces = [
        ...state.pieces
    ].sort((a, b)=>a.id.localeCompare(b.id)).map((p)=>`${p.id}:${p.r},${p.c}`).join('|');
    const chain = state.chain ? `${state.chain.wolfId}:${state.chain.count}` : '-';
    return `${pieces}::${[
        ...state.rocks
    ].sort().join(',')}::${state.toMove}::${chain}`;
}
function applyRepetitionGuard(state) {
...
const usePlayStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zustand$40$5$2e$0$2e$14_$40$types$2b$react$40$19$2e$2$2e$17_react$40$19$2e$2$2e$7$2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        init (levelId, rocks, difficulty, targetEaten, maxPlies) {
            ...
            turnSeq += 1;
            const state = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$src$2f$rules$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createInitialState"])(levelId, rocks, targetEaten, maxPlies);
...
//# sourceMappingURL=_36228f02._.js.map