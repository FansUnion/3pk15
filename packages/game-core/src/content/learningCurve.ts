...
export const LEARNING_STAGE_CONTRACTS: Record<LearningStageId, LearningStageContract> = {
  'spring-intro': { id: 'spring-intro', labelZh: '规则引入', mustShowZh: '合法自保，并保留第一次捕食的教学空间', automatedEvidenceZh: '无严格劣着；新手画像能够建立首次捕食' },
  'spring-tactics': { id: 'spring-tactics', labelZh: '短链练习', mustShowZh: '避开直接送子，并开始封堵一次落点', automatedEvidenceZh: '责任动作与短链反例通过' },
  'spring-exam': { id: 'spring-exam', labelZh: '春季综合', mustShowZh: '限制单狼，并开始识别双狼协作', automatedEvidenceZh: '固定猎手不能无代价重复得分' },
  'summer-routes': { id: 'summer-routes', labelZh: '路线与退路', mustShowZh: '预判完整狼回合并管理通道', automatedEvidenceZh: '完整捕食链和退路反例通过' },
  'summer-teamwork': { id: 'summer-teamwork', labelZh: '三狼分工', mustShowZh: '识别孤狼，并持续局部封锁', automatedEvidenceZh: '连续两轮保持同一防守目标' },
  'summer-exam': { id: 'summer-exam', labelZh: '夏季综合', mustShowZh: '识别战术牺牲、退路和关键落点', automatedEvidenceZh: '牺牲收益可由独立教师解释' },
  ...
  'autumn-exam': { id: 'autumn-exam', labelZh: '秋季综合', mustShowZh: '把羊方优势主动转成困狼', automatedEvidenceZh: '合围持续推进，且无优势往返' },
  'winter-pressure': { id: 'winter-pressure', labelZh: '高压站位', mustShowZh: '阻断固定套路，并切断狼间接应', automatedEvidenceZh: '资深固定猎手画像受到有效防守' },
  'winter-expert': { id: 'winter-expert', labelZh: '专家防守', mustShowZh: '多回合保持目标，并主动困狼', automatedEvidenceZh: '教师后悔值和目标持续性达标' },
  'winter-final': { id: 'winter-final', labelZh: '最终综合', mustShowZh: '本期最强公平防守，并保留可理解的狼胜路线', automatedEvidenceZh: '无重复收割漏洞；保留双方代表棋谱' },
}
...
export function learningStageForLevel(level: Pick<LevelConfig, 'chapterId' | 'indexInChapter'>): LearningStageContract {
  ...
  return LEARNING_STAGE_CONTRACTS[STAGE_ORDER[level.chapterId][pair]!]
}
